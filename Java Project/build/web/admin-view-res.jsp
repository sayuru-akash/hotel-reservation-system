...
<html>
    <head>
        ...
        <meta content="View Reservations" property="og:title" />
        <meta content="View Reservations" property="twitter:title" />
    ...
    <body>
        <div class="section-14 wf-section">
            <img
                ...
                width="150"
                />
            <h1 class="heading-14">View Reservations</h1>
        ...
        <div class="section-16 wf-section">
            ...
            <div class="div-block-50">
                <h2 class="heading-15">All Reservations (Newest First)</h2>
                <table border="1" style="margin: 50px !important;">
                    <tr>
                        <td><h4>Reservation ID</h4></td>
                        <td><h4>Adults</h4></td>
                    ...
                    <%
                        try {
                            ...
                            String sql = "select b.resid, b.adults, b.children, b.cidate, b.codate, u.fname, u.mobile from bookings as b natural join users as u order by b.resid desc";
                    ...
                    <tr>
                        ...
                        <td><%=rs.getString("cidate")%></td>
                        <td><%=rs.getString("codate")%></td>
