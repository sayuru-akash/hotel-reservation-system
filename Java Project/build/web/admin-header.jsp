<%-- 
    ...
    Created on : Jan 27, 2022, 1:48:01 AM
    Author     : sayur
--%>
    ...
    >
      <div class="container-light-nav w-container">
        ...
        <nav role="navigation" class="nav-menu w-nav-menu">
          <a
            href="./index.html"
            class="navbar-light-bold-link w-nav-link"
            style="max-width: 100%"
            >Home</a
          ><a
            href="./about.jsp"
          ...
          ><a
            ...
            style="max-width: 100%"
            >Contact</a
          ><a href="./AdminDashboard" class="navbar-light-navbutton w-button">Admin Panel</a>
        </nav>
        <div
